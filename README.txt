...
I have simply chosen to ignore this as it's only a website on project management 


if running code on windows terminal:

cd react-assn4
npm install
node index.js   # backend goes to index.js which it set up to handle the new projects added
